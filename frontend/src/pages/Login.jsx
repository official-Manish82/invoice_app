...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 relative overflow-hidden p-4">
      ...
      <div className="relative w-full max-w-[400px] bg-white rounded-2xl shadow-xl border border-slate-200/60 p-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-slate-500 mt-2">Enter your details to sign in to your account</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <Link to="#" className="text-xs font-medium text-slate-900 hover:underline">Forgot password?</Link>
            </div>
